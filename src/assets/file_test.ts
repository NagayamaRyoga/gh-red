...
Deno.test(async function testFindAssetURL(t) {
  ...
  const downloads = {
    ...
    "NagayamaRyoga/jargon": [
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_0.1.2_checksums.txt",
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Darwin_amd64.tar.gz",
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Darwin_arm64.tar.gz",
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Linux_amd64.tar.gz",
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Linux_arm64.tar.gz",
      "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Linux_i386.tar.gz",
    ],
    "x-motemen/ghq": [
  ...
  const tests: ReadonlyArray<Test> = [
    ...
    {
      description: "NagayamaRyoga/jargon",
      input: {
        artifactURLs: downloads["NagayamaRyoga/jargon"],
      },
      expected: {
        linux_x86_64:
          "https://github.com/NagayamaRyoga/jargon/releases/download/v0.1.2/jargon_Linux_amd64.tar.gz",
